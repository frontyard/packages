...
abstract class TestHostVideoPlayerApi {
  ...
  static void setup(TestHostVideoPlayerApi? api, {BinaryMessenger? binaryMessenger}) {
    ...
    {
      final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
          'dev.flutter.pigeon.AndroidVideoPlayerApi.setPreferredAudioLanguage', codec,
          binaryMessenger: binaryMessenger);
      if (api == null) {
        _testBinaryMessengerBinding!.defaultBinaryMessenger.setMockDecodedMessageHandler<Object?>(channel, null);
      } else {
        _testBinaryMessengerBinding!.defaultBinaryMessenger.setMockDecodedMessageHandler<Object?>(channel, (Object? message) async {
          assert(message != null,
          'Argument for dev.flutter.pigeon.AndroidVideoPlayerApi.setPreferredAudioLanguage was null.');
          final List<Object?> args = (message as List<Object?>?)!;
          final PreferredAudioLanguageMessage? arg_msg = (args[0] as PreferredAudioLanguageMessage?);
          assert(arg_msg != null,
              'Argument for dev.flutter.pigeon.AndroidVideoPlayerApi.setPreferredAudioLanguage was null, expected non-null PreferredAudioLanguageMessage.');
          api.setPreferredAudioLanguage(arg_msg!);
          return <Object?>[];
        });
      }
    }
